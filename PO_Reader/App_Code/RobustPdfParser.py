#!/usr/bin/env python3
"""
Robust PDF Parser that correctly handles the complex table structure
"""
...
class RobustPdfParser:
    ...
    def _parse_single_item(self, lines: List[str], start_idx: int) -> Optional[Dict[str, Any]]:
        ...
        # For now, we'll extract basic information without the complex numeric matching
        # This is a simplified version that focuses on getting the item codes and descriptions
...
def main():
    ...
    """
    if len(sys.argv) != 2:
        print("Usage: python3 RobustPdfParser.py <pdf_path>")
        sys.exit(1)
